...
definicion_variables : RWORD_DEFINIR IDENTIFICADOR PUNTCHAR_PUNTOCOMA { printf("definir %s\n", yylval.str); }
			     | RWORD_DEFINIR IDENTIFICADOR PUNTCHAR_PUNTOCOMA definicion_variables { printf("definir %s\n", yylval.str); }
					 | error
